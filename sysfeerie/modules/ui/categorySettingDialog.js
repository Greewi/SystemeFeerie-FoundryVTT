...
export class CategorySettingDialog extends FormApplication {

	/** @override */
	static get defaultOptions() {
		return mergeObject(super.defaultOptions, {
			classes: ["sysfeerie"],
			template: SFUtility.getSystemRessource("templates/dialog/categorySetting-dialog.html"),
			id:'settings_categories',
			title:game.i18n.localize("SYSFEERIE.Settings.Categories"),
			resizable:true,
			width: 650,
			height: 500,
			scrollY : [".categorySetting_content"]
		});
	}
