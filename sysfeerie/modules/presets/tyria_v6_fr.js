	...
	"categories": [
		{
			...
			"short":"LT",
			"description":"Représente la lignée du personnage, son espèce.",
			"levels": [
		...
		},
		{
			...
			"icon":"icons/magic/control/buff-strength-muscle-damage-orange.webp",
			"short":"Q",
			"description":"Réprésente des qualités du personnages, des particularités physiques ou mentales qui peuvent lui donner un avantage dans certaines situations.",
			"levels": [
			...
			"levels": [
				...
				"Ordinaire : un objet de facture standard.",
				"Chef d'œuvre : un objet de très bonne facture, rarement enchantés.",
				"Exotique : un objet de facture exceptionnelle, souvent enchanté par de la magie.",
				"Légendaire : un objet légendaire de grande puissance."
			]
		},{
			"id":"EVENT",
			"name":"Événement",
			...
			"description":"Représente le matériel usuel du personnage.",
			"levels": [
				"Inconnu : personne n'a jamais entendu parler de cet événement.",
				"Confidentiel : très peu personnes ont entendu parler de cet événement ou de l'implication de votre personnage.",
				"Local : seul des personnes proches de l'événement connaissent l'implication de votre personnage.",
				"Publique : la plupart des gens de la région où a eu lieu l'événement connaissent l'implication de votre personnage.",
				"Légende : l'intégralité du monde connu a entendu parler de cet événement et connait l'implication de votre personnage."
			]
		}
	]
}